...
_v5 — 2026-09-04: reverted the v4 OpenWeather-Rain custom raster (a coarse point-grid can't reproduce real radar imagery); the OpenWeather "Rain" toggle now shows OpenWeather's own precipitation_new tile directly, matching how their own site renders it._
